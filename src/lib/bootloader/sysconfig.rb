...
module Bootloader
  ...
  class Sysconfig
    ...
    def self.from_system
      ...
      # FIXME: this assumes the default is "yes"
      trusted_boot = Yast::SCR.Read(AGENT_PATH + "TRUSTED_BOOT") != "no"
    ...
    PROPOSED_COMMENTS = {
      ...
      trusted_boot: "\n" \
        ...
        "# FIXME here we explain the benefits and distinction from Secure Boot\n" \
